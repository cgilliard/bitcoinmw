...
impl Cpsrng {
	...
	pub fn next_u64(&mut self) -> u64 {
		let mut v: u64 = 0;
		self.gen(unsafe {
			crate::core::slice::from_raw_parts_mut(&mut v as *mut u64 as *mut u8, 8)
		});
		v
	}
}
...
mod test {
	...
	#[test]
	fn test_seed() {
		let mut r = Cpsrng::new_s([8u8; 32]).unwrap();
		let v1 = r.next_u64();
		assert_eq!(v1, 3877200735786743394);
		let mut r2 = Cpsrng::new().unwrap();
		let mut r3 = Cpsrng::new().unwrap();
